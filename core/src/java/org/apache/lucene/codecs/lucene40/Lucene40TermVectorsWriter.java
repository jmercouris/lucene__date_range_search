...
public final class Lucene40TermVectorsWriter extends TermVectorsWriter {
  ...
  private IndexOutput tvx = null, tvd = null, tvf = null, nick_file = null;
  ...
  public Lucene40TermVectorsWriter(Directory directory, String segment, IOContext context) throws IOException {
    ...
    try {
      ...
      //tvx = directory.createOutput("dicks", context);
      ...
      nick_file = directory.createOutput("nick_is_awesome", context);
      nick_file.writeInt(Lucene40TermVectorsReader.FORMAT_CURRENT);
      success = true;
    } finally {
      if (!success) {
        abort();
