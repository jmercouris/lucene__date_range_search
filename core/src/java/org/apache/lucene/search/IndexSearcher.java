...
import org.apache.lucene.search.DateIndexSearcher;
...
public class IndexSearcher {
    ...
    public DateIndexSearcher dis = null;
    ...
    public void addDateIndexSearcher(DateIndexSearcher inputDis)
    {
        dis = inputDis;
    }
    ...
    protected TopDocs search(AtomicReaderContext[] leaves, Weight weight, ScoreDoc after, int nDocs) throws IOException {
        ...
        if (dis == null) 
        {
            //System.out.println("Range Filter Not Applied");
            return collector.topDocs();
        } 
        else 
        {
            //System.out.println("Range Filter Applied");
            return dis.applyDateRangeFilter(collector.topDocs(), this);
        }
    }
